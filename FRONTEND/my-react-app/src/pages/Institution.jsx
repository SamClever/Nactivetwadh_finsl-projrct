...
export default function Institution() {
  ...
  const [formData, setFormData] = useState({
    ...
    infrastructure_buildings: [
      ...
      { type: "Cafeterias (students)", count: "", area: "", ownership: { owned: false, leased: false, hired: false } },
      { type: "Canteen (staff)", count: "", area: "", ownership: { owned: false, leased: false, hired: false } },
      { type: "Staff quarters", count: "", area: "", ownership: { owned: false, leased: false, hired: false } },
      { type: "Bookshops", count: "", area: "", ownership: { owned: false, leased: false, hired: false } },
      { type: "Equipment and Tools (Computers)", count: "", area: "", ownership: { owned: false, leased: false, hired: false } },
      { type: "Equipment / Tools (Other specific)", count: "", area: "", ownership: { owned: false, leased: false, hired: false } },
      { type: "Furniture", count: "", area: "", ownership: { owned: false, leased: false, hired: false } },
      { type: "Audio Visual Aids", count: "", area: "", ownership: { owned: false, leased: false, hired: false } },
      { type: "Library books", count: "", area: "", ownership: { owned: false, leased: false, hired: false } },
      { type: "Library journals", count: "", area: "", ownership: { owned: false, leased: false, hired: false } },
    ],
    equipment_desc: "",
